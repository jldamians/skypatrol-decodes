...
/*
* Convierte valores Ascii ha valores hexadecimales
* @param {string} ascii: valor ascii
* @return {string}
*/
exports.asciiToHex = function(ascii){
	var hexadecimal = '';

	ascii = helper.trim(ascii);

	// false => 0, -0, NaN, null, undefined, "", ''
	// true  => resto de valores
	if (ascii) {
		for (var i = 0; i < ascii.length; i++) {
			hexadecimal += ascii.charCodeAt(i).toString(16);
		};
	}
