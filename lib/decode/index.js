...
var Decode = (function(){
    ...
    function _init(trama, ip, port) {
        ...
        _ascii = _trama ? base.hexToAscii(_trama) : '';
        _ascii = _ascii ? _ascii.split(',') : [];
    }
        ...
        init: function(trama, ip, port) {
            ...
            return {
                database: function() {
                    ...
                    var utctime = this.date().toFormat(CUSTOM_DATE.dateFormat) + ' ' + this.time().toFormat(CUSTOM_DATE.timeFormat);
                    ...
                    var numofsat = -1;
                    var locquality = -1; 
                    var engineon = 0; // ignicion(1)
                    var extinputa = -1; 
                    var extinputb = -1; 
                    var extinputc = 0; // ignicion(1)
                    var extinputd = -1;
                    var extinpute = -1;
                    var extinputf = 0; // panic(1)
                    var versionnum = '-1'; 
                    var ip = _ip;
                    ...
                    var outputa = -1;
                    var outputb = -1;
                    var outputc = 0; // inmobilizer(1) / mobilizer(0)
                    var outputd = -1; 
                    var optionalinput = -1;
                    var gpscommstatus = -1;
                    var rawdata = _trama;
                ...
                deviceIndicators: function() {
                    ...
                    if (_ascii.length < 1 || !_ascii[0]) {
                        return {};
                    }

                    value = helper.trim(_ascii[0]);
                ...
                latitude: function() {
                    ...
                    if (_ascii.length >= 4 && _ascii[3]) {
                        latitud = helper.trim(_ascii[3]);
                        ...
                        if (_ascii.length >= 5 && _ascii[4] && helper.trim(_ascii[4]) == 'S') {
                            latitud = latitud * -1;
                        }
                    }
                ...
                longitude: function() {
                    ...
                    if (_ascii.length >= 6 && _ascii[5]) {
                        longitud = helper.trim(_ascii[5]);
                        ...
                        if (_ascii.length >= 7 && _ascii[6] && helper.trim(_ascii[6]) == 'W') {
                            longitud = longitud * -1;
                        }
                    }
                ...
                groundSpeed: function() {
                    ...
                    if (_ascii.length >= 8 && _ascii[7]) {
                        console.log('groundSpeed =>', _ascii[7]);
                        value = helper.trim(_ascii[7]);
                ...
                speedDirection: function() {
                    ...
                    if (_ascii.length >= 9 && _ascii[8]) {
                        console.log('speedDirection =>', _ascii[8]);
                        value = helper.trim(_ascii[8]);
                        value = Number(value);
                    }
                ...
                date: function() {
                    ...
                    if (_ascii.length < 10 || !_ascii[9]) {
                        return {};
                    }

                    value = helper.trim(_ascii[9]);
                    ...
                    return {
                        ...
                        toFormat: function(format) {
                            var value = date.fromText(this.toText(), CUSTOM_DATE.dateFormatGps);
                ...
                time: function() {
                    ...
                    if (_ascii.length < 2 || !_ascii[1]) {
                        return {};
                    }

                    value = helper.trim(_ascii[1]);
                    value = helper.lpad(value, 6);
                    ...
                    return {
                        ...
                        toFormat: function(format) {
                            var value = date.fromText(this.toText(), CUSTOM_DATE.timeFormatGps);
                            return date.toFormat(value, format);
                        }
                    }
                },
                ...
                vehicleIndicators: function() {
                    ...
                    if (_ascii.length < 13 || !_ascii[12]) {
                        return {};
                    }

                    value = helper.trim(_ascii[12]);
                ...
                validator: function() {
                    ...
                    if (_ascii.length >= 3 && _ascii[2]) {
                        console.log('validator =>', _ascii[2]);
                        value = helper.trim(_ascii[2]);
                    }
